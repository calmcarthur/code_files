x = int(input('Welcome to the Collatz Conjecture Script. This script takes any positive integer and computes it to 1. How? \nWell,\
...
print('And there you see, any number will end at 1... we think!')