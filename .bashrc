[ -f "/c/Users/mcart/bin/win-sudo/s/path.sh" ] && source "/c/Users/mcart/bin/win-sudo/s/path.sh"
...
# ommited directories for cleaner terminal use
LS_COMMON="-hG"
...
LS_COMMON="$LS_COMMON -I 'My Pictures'"
LS_COMMON="$LS_COMMON -I 'My Videos'"
LS_COMMON="$LS_COMMON -I 'My Music'"
